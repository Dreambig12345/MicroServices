package com.springboot.EmployeeSearchService.service;
...
import com.springboot.EmployeeSearchService.domain.model.Employee;
@Service
public class EmployeeSearchService {
 private static Map < Long, Employee > EmployeeRepsitory = null;
 static {
  Stream < String > employeeStream = Stream.of("1,Nuthan  Kumar,Java,Engineer", "2,Nitin  Bharadwaj,AWS,TLM Lead",
   "3,Biswajit  Mohanty,AI,Sr.Architect","5,Megha  Thyagi,DBA,Project Lead");
